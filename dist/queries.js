const queries = {
    ...
    updateUserByAdmin: "UPDATE users SET username = $1, role = $2, balance = $3 WHERE id = $4 RETURNING id, username, role, balance",
    updateUser: "UPDATE users SET username = $2, password = $3 WHERE id = $1 RETURNING id, username, role, balance",
    deleteUser: "DELETE FROM users WHERE id = $1",
    fundUser: "UPDATE users SET balance = balance + $1 WHERE id = $2 RETURNING id, username, role, balance"
};
export default queries;
export const carQueries = {
    getAllCars: "SELECT id, model, price, owner_id FROM cars",
